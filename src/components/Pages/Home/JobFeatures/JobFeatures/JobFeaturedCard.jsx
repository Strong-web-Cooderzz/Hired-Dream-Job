    ...
    <div className="job-card w-11/12  mx-auto  py-2">
      <div className="">
        <div className="flex justify-between">
          <button className="job-feature-btn-left bg-zinc-200 ">
            {" "}
            Internship{" "}
          </button>
          <button className="job-feature-btn bg-zinc-300 text-blue-600 mr-3">
            {" "}
            Full time{" "}
          </button>
        </div>
        <button className="job-feature-btn-left bg-orange-100 text-orange-500 mt-2">
          {" "}
          Part time{" "}
        </button>
      </div>
      <div className="flex justify-center relative -mt-6">
        <img className="w-16 h-16 rounded-full ml-3" src={logo} alt="" />
      </div>
