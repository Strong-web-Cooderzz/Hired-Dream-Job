...
const FindJob = () => {
  ...
  const fetchFromServer = (e) => {
    ...
    setDataLoading(true);
    fetch(
      `http://localhost:5000/find-jobs?search=${searchString}&location=${location}&sort=${sort}&type=${jobType}&time=${time}&per-page=${perPage}&page=${page}&experience=${experience}`
    )
      .then((res) => res.json())
      .then((data) => {
        setData(data);
      ...
      <div className="mt-0 relative lg:static">
        ...
        <div className="rounded-md grid lg:grid-cols-4">
          <div
            ...
            } lg:translate-x-0 transition-transform lg:col-span-1 bg-[#e8eefa] p-6 pt-10 md:pt-6 absolute lg:static top-16 right-0 lg:top-auto lg:right-auto z-10`}
          >
            <div>
              <button
                onClick={() => setIsOpen(!isOpen)}
            ...
            <div>
              <div
                ...
                className="mt-6 [&>div>label]:text-sm [&>div>label]:text-gray-500 [&>div>label]:ml-2"
              >
          ...
          <div className="lg:col-span-3">
            <div className="px-5">
              <div className="flex lg:justify-end items-center justify-center lg:my-4 my-5">
                <select
                  onChange={() => setNewer(!newer)}
                  className="mr-3 bg-gray-200 focus:outline-none py-3 px-4 rounded-md text-sm"
                >
                ...
                <select
                  ...
                  className="bg-gray-200 focus:outline-none py-3 px-4 rounded-md text-sm"
                >
