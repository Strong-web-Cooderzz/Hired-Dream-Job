...
const ApplyJobModal = ({ singleJobData, user }) => {
	...
	const jobApplyFormHandlar = (e) => {
		...
		const jobApplyInfo = { candidateResume, candidateMessage, company, companyType, jobType, jobTitle: title, jobId: _id, companyId: company._id, companyLocation: location }
