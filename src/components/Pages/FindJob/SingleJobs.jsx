...
const SingleJobs = () => {
	...
	useEffect(() => {
		fetchData.get(`/jobs/${id}`).then((response) => {
					...
					<div className="lg:flex block mt-10 mb-16 gap-10">
						<div className="basis-2/3">
									...
									<div className="flex items-center gap-4">
										...
										{!user && (
											<button
												...
												className={`${new Date() > new Date(jobData.expireDate)
										...
										<button
											...
											className="p-4 text-blue-500 bg-blue-50 rounded-md"
										>
											<BsBookmark />
										</button>
									</div>
							...
							<div className="px-5">
								...
								<div>
									<h1 className="text-xl font-medium mt-6 mb-2">
								...
								<div className="bg-gray-50 p-5 rounded-lg mt-8">
									...
									<div className="mt-6 flex flex-col gap-4">
										...
										<a
											...
											target="_blank"
											className="text-blue-500 bg-blue-200 text-center px-auto w-full py-2 rounded-md"
										>
