				...
				}
				{
					!dataLoading && <>
						...
						<section className="bg-blue-50 hidden lg:flex items-center px-12 py-16">
							<img src={employer.photo} className="w-24 h-24 bg-green-300 rounded-full object-cover" />
						...
						{/* details */}
						<section className="px-6 md:px-12 flex flex-col lg:flex-row gap-8 md:gap-16 mt-16">
