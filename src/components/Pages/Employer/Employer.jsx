			...
			<main className="flex flex-col-reverse lg:flex-col mb-16">
				{/* short details */}
					<div className="bg-gradient-to-r from-sky-400 to-purple-400 hidden lg:flex items-center px-12 py-6">
						...
						<div className="ml-4 flex flex-col gap-3">
							...
							<div>
								<span className="text-xs text-blue-700 bg-blue-200 px-6 py-1 mt-1 rounded-full">Open Jobs - {employer?.available}</span>
							</div>
						</div>
				...
				<secction className="px-6 md:px-12 flex flex-col lg:flex-row gap-8 md:gap-16 mt-16">
					<div className="lg:w-9/12 flex flex-col">
						...
						<span className="text-xl font-medium mt-6">3 other jobs available</span>
						{/* cards */}
					...
					<div className="lg:w-3/12">
						...
						<div className="flex flex-col bg-blue-50 p-6 gap-4">
							...
							<a className="bg-blue-200 flex justify-center py-3 text-blue-700 rounded-md" href={employer.employData?.website}><button>{employer.website}</button></a>
