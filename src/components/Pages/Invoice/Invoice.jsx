...
export default function Invoice() {
	return (
		<main className="bg-blue-50 h-full py-10 md:py-20">
			<section className="w-11/12 md:w-8/12 mx-auto">
				...
				{/* invoice */}
				<div className="mt-10 md:mt-20 bg-white py-20 px-16 rounded-md">
					{/* logo and invoice */}
					<div className="flex-col">
						<div className="flex flex-col md:flex-row gap-6 md:gap-0">
							<span className="text-2xl font-bold md:w-7/12">Logo</span>
						...
						<div className="flex">
							<div className="flex flex-col mt-16 md:w-7/12">
