...
import EmployerFollower from '../EmployerFollower/EmployerFollower';


const EmployerNotificationsFollower = () => {
 ...
 <div className='lg:w-1/3 md:w-full sm-full w-full mx-auto lg:mt-0 md:mt-5 mt-7 bg-white rounded-md h-96 py-4 px-2 overflow-y-scroll'>
              ...
              <div className='pl-3 grid lg:grid-cols-1 md:grid-cols-2 md:gap-4 mt-2'>
               {
                follower.map(data => <EmployerFollower 
                    key={data.id} 
                    data = {data}
                 >  </EmployerFollower>)
               }
...
export default EmployerNotificationsFollower;