...
console.log(jobs);
                ...
                <tbody>
                    {
                       ...
                       <>
                        ...
                        <tr key={job._id} class="border-b">
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                            <img src={job.logo} className='w-12 h-12 rounded-full' alt="" />
                            </td>
                        <td class="text-sm text-gray-900 text-left font-light px-6 py-4 whitespace-nowrap">
                         {job.title} <span className='bg-orange-100 text-orange-600 px-2 rounded-md '>3</span>
                        </td>
                        ...
                        <td class="text-sm flex gap-1 font-light px-6 py-4 whitespace-nowrap">
                          <Link to={`/edit-job/${job._id}`} className='inline-block bg-blue-100 px-2 py-2 rounded-md text-blue-600 shadow-md hover:bg-blue-400 hover:text-white'><BsPencil /></Link>
                          {/* Warning Btn */}
  ...
  <div>
    <div class="dropstart relative">
     <Link id="dropdownMenuButton1s"
        data-bs-toggle="dropdown"
        aria-expanded="false" className=' dropdown-toggle inline-block bg-rose-100 px-2 py-2 rounded-md text-rose-600 shadow-md hover:bg-rose-400 hover:text-white'><BiTrash /></Link>
      <ul
        class="
          dropdown-menu
          min-w-max
  ...
  <div class="modal-dialog relative w-auto pointer-events-none">
    <div
      ...
      <div
        ...
        <h5 class="text-xl font-medium leading-normal text-gray-800" id="exampleModalLabel">Job Warning...</h5>
        <button type="button"
          class="btn-close box-content w-4 h-4 p-1 text-black border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-black hover:opacity-75 hover:no-underline"
          data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body relative p-4">
        <textarea className='h-64 w-full border border-blue-400 rounded-md p-4' placeholder='Write Report'></textarea>
      </div>
      <div
