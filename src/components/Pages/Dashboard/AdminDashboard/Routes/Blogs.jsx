                ...
                <tbody>
                    {
                       ...
                       <>
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                            <img src={blog.image} className='w-12 h-12 rounded-full' alt="" />
                            </td>
                        ...
                        <td class="text-sm flex gap-1 font-light px-6 py-4 whitespace-nowrap">
                          <Link to={`/edit-blog/${blog._id}`} className='inline-block bg-blue-100 px-2 py-2 rounded-md text-blue-600 shadow-md hover:bg-blue-400 hover:text-white'><BsPencil /></Link>
                          {/* Warning Btn */}
    ...
    <div class="dropstart relative">
     <Link id="dropdownMenuButton1s"
      ...
      >
        ...
        <li>
          <a onClick={()=>handleDelete(blog._id)}
            class="
              dropdown-item
              text-sm
              py-2
