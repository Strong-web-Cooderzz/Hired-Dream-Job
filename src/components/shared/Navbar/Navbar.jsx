    ...
    return (
        <nav className="w-full bg-white shadow">
            <div className="justify-between px-4 md:items-center md:flex md:px-8">
                ...
                <div>
                    <div
                        className={`flex-1 justify-self-center pb-3 mt-8 md:block md:pb-0 md:mt-0 transition-all ${navbar ? "block" : "hidden"
                            }`}
                    >
                            ...
                            <li className="text-white">
                                {user?.uid ? (
                                    <div className="relative">
                                        ...
                                        <label
                                            htmlFor="sortbox"
                                            className={`flex items-center space-x-1 cursor-pointer ${user?.photoURL ? "w-[32px]" : "w-full"
                                                }`}
                                        >
                                            {user?.photoURL ? (
                                                <img
